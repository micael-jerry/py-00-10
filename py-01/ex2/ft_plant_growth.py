...
class Plant:
    ...
    def growth_simulation(self, num_of_days: int) -> None:
        ...
        for day in range(num_of_days):
            ...
            plant_cp.grow()
            plant_cp.age()
            print(f"{plant_cp.__name}: {plant_cp.__height}cm, {plant_cp.__age} days old")

        print(f"Growth this week: {round(plant_cp.__height - self.__height)}cm")


def main() -> None:
    rose: Plant = Plant("Rose", 25, 30)
    rose.growth_simulation(7)
